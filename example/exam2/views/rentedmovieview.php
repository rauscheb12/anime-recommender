...
echo"<td><form action='index.php?mode=confirmreturnmovies&movieid={$row['movie_id']***REMOVED*** &title={$row['title']***REMOVED***' method='post'><button type='submit' class='btn btn-primary'>
