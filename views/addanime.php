...
<head>
    <title>Anim.mender - Add an Anime</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="./addanime.html">Add an Anime
    ...
    <div class="row">
        ...
        <div class="form-group col-10">
            <label for="anime-name">Title:</label>
            <input type="text" class="form-control" id="anime-name">
        </div>
        <div class="col"></div>
    </div>
